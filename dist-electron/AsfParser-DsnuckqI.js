import { u as H, h as P, s as V, e as $, f as b, j as o, k as E, m as W, l as A, S as h, A as _, B as J, c as q, T as z } from "./main-Zq7DLSnH.js";
class e {
  ...
  static encode(t) {
    ...
    return r.setUint32(0, Number.parseInt(t.slice(0, 8), 16), !0), r.setUint16(4, Number.parseInt(t.slice(9, 13), 16), !0), r.setUint16(6, Number.parseInt(t.slice(14, 18), 16), !0), a.set(P(t.slice(19, 23)), 8), a.set(P(t.slice(24)), 10), a;
  }
  constructor(t) {
    this.str = t;
  }
...
class w extends l {
  get(t, a) {
    ...
    for (let i = 0; i < w.contentDescTags.length; ++i) {
      ...
      if (d > 0) {
        const u = w.contentDescTags[i], C = c + d;
